    ...
    class Context(AbstractRuntimeContext):
        ...
        def _exec_with_pipe(self, source):
            ...
            try:
                ...
                p = Popen(cmd, stdin=PIPE, stdout=PIPE, stderr=PIPE, cwd=self._cwd, universal_newlines=True, startupinfo=startupinfo)
            ...
            try:
                ...
                try:
                    ...
                    if os.name == 'nt':
                        startupinfo = subprocess.STARTUPINFO()
                        startupinfo.dwFlags |= subprocess.STARTF_USESHOWWINDOW
                    p = Popen(cmd, stdout=PIPE, stderr=PIPE, cwd=self._cwd, universal_newlines=True, startupinfo=startupinfo)
